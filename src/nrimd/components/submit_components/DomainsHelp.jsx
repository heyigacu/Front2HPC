...
const DomainsHelp = () => {
  ...
  return (
    <>
      ...
      <Modal title="How to set domain information:" closable={false} footer={null} open={isModalOpen} okText={false} cancelText={false} onCancel={handleCancel} width={1000}>
        <div>
        ...
        <img src={result_domain} style={{width:"50%"}}></img>
        <div>
