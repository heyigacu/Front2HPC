  ...
  const getItems = (panelStyle) => [
    ...
    },
    {
      ...
      <>{
        ...
        :
        <>Sorry, some error occurred when calculating PRS</>
      }</>
      :
      <div>Users can select PRS when submitting the jobs.</div>  
      }</>,
      style: panelStyle,
    },
    {
      ...
      <>{results.data.ehh.status=="Right"?
        ...
        :
      <>Sorry, some error occurred when calculating EHH</>
      }</>
      :
      <div>Users can select EHH when submitting the jobs.</div>  
      }</>,
      style: panelStyle,
    },
    {
      ...
      children: <>
      {
        ...
        <>{results.data.cna.status=="Right"?        
          ...
          :
          <div>Sorry, some error occurred when calculating CNA</div>  
          }</>
        :
        <>Users can select CNA when submitting the jobs. </>
      }
      </>,
      style: panelStyle,
    },
