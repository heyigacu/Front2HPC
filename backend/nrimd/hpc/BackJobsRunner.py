...
class BackJobsRunner:
    ...
    def __init__(self,jobid,filename,params):
        # self.jobid = jobid
        # self.filepath = '/media/volume/sdb/jobs/ca_trajs/'
        # self.filename = filename #jobid_numresidues_nummodels.pdb
        # self.params = params
        ...
        # self.codeDir = '/N/u/soicwang/BigRed200/projects/halfPrecision4HPC/'    

        self.jobid = jobid
        self.filepath = NRIMD_DATA_DIR+'/ca_trajs/'
        self.filename = filename #jobid_numresidues_nummodels.pdb
        self.params = params
        self.slurmDir = NRIMD_DATA_DIR+'/slurmDir/'
        self.slurmHPCDir = '/N/u/soicwang/BigRed200/inputslurmDir/'
        self.inputHPCDir = '/N/u/soicwang/BigRed200/inputPDBDir/'
        self.codeDir = '/N/u/soicwang/BigRed200/projects/halfPrecision4HPC/'    
    ...
    def submit(self):
        ...
        cmd = 'cp ' + self.filepath + self.filename + ' ' + self.filepath + self.jobid +'.pdb'
        os.system(cmd)
